...
functionalities. The notebook also shows many examples of the results of the neural style transfer. The code runs so fast that 
I thought it may be useful to make a function that can iterate through many content and style images at once. 
